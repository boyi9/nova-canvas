...
const messages = {
  en: {
    ...
    description: 'An nova canvas for image creation that brings canvas composition, AI generation, reference editing, prompt libraries, and reusable assets into one workflow.',
    quickStart: 'Quick Start',
    demo: 'Live Demo',
    gallery: 'Gallery',
    features: 'Explore Features',
    previewAlt: 'Nova Canvas preview',
