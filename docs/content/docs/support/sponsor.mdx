...
You can support Nova Canvas by starring the repository, sponsoring project placement, or providing subscriptions to AI development tools such as Codex or Claude. Support is used for AI development tools, model services, and project maintenance.
