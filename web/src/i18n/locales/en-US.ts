export default {
    meta: {
        title: "Nova Canvas",
        description: "An nova canvas creation tool",
    },
    ...
    canvas: {
        ...
        complianceClean: "Content is compliant, no risks found",
        complianceSummary: "Found {{count}} compliance risk(s) (score {{score}})",
        complianceField: "Field",
        complianceCategory: "Category",
        complianceKeyword: "Matched term",
        complianceSuggestion: "Suggestion",
        ...
        recipe: "Recipe",
        recipeSave: "Save canvas as recipe",
        recipeNamePlaceholder: "Recipe name (e.g. 11.11 beauty seeding)",
        recipeNameRequired: "Please enter a recipe name",
        recipeApply: "Apply",
        recipeBack: "Back",
        recipeConfirmApply: "Confirm apply",
        recipeFillParams: "Fill recipe parameters",
        recipeEmpty: "No saved recipes yet — save the current canvas as a recipe",
        recipeEmptyCanvas: "Canvas is empty, cannot save a recipe",
        recipeSaved: "Recipe saved",
        recipeApplied: "Recipe applied to canvas",
        ...
        detailLayoutApplied: "Arranged {{count}} nodes into the best-selling detail-page structure",
        ...
        export: { defaultProjectName: "Nova Canvas", defaultNodesName: "Canvas elements", item: "Element" },
        createMenu: {
            fromNode: "Generate from this node", close: "Close", text: "Generate text", textDescription: "Scripts, ad copy, and brand content", novaText: "Generate rich text", novaTextDescription: "Rich text editing with formatting support", product: "Product node", productDescription: "Product name, price, selling points", storyboard: "Storyboard node", storyboardDescription: "Storyboard script, scene description", videoTrack: "Video track", videoTrackDescription: "Video clips, duration", recipe: "Recipe node", recipeDescription: "Brand recipe, parameters", multimodal: "Multimodal node", multimodalDescription: "Multimodal input combination", image: "Generate image", video: "Generate video", audio: "Audio reference", config: "Configuration node", configDescription: "Model, size, count, and input order", select: "Select a node",
        },
        node: {
            node: "Node",
    ...
    home: {
        ...
        description: "Generate, connect, and reshape <content>images, text, and graphics</content> in <canvas>Nova Canvas</canvas>, turning one-off generations into a continuous creative process.",
        start: "Get started",
    ...
    config: {
        ...
        localStorage: {
            ...
            description: "View browser data saved by Nova Canvas, grouped by object store.",
