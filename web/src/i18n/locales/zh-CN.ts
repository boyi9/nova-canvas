export default {
    ...
    assets: {
        ...
        kinds: { text: "文本", novaText: "富文本", image: "图片", video: "视频", audio: "音频", product: "商品", storyboard: "分镜", videoTrack: "视频轨道", recipe: "配方", multimodal: "多模态" },
        fields: {
            title: "标题",
            titleRequired: "请输入标题",
    ...
    canvas: {
        ...
        compliance: "合规检测",
        complianceClean: "内容合规，未发现风险",
        complianceSummary: "发现 {{count}} 处合规风险（合规分 {{score}}）",
        complianceField: "位置",
        complianceCategory: "类型",
        complianceKeyword: "命中词",
        complianceSuggestion: "建议",
        complianceClose: "关闭",
        undo: "撤销",
        redo: "重做",
        openMenu: "打开画布菜单",
        ...
        autoLink: "智能关联",
        autoLinkDone: "已自动建立 {{count}} 条关联连线",
        autoLinkNone: "未发现可自动关联的节点",
        recipe: "配方",
        recipeSave: "保存当前画布为配方",
        recipeNamePlaceholder: "配方名称（如：双十一美妆种草）",
        recipeNameRequired: "请输入配方名称",
        recipeApply: "应用",
        recipeBack: "返回",
        recipeConfirmApply: "确认应用",
        recipeFillParams: "填写配方参数",
        recipeEmpty: "还没有保存的配方，先保存当前画布为配方吧",
        recipeEmptyCanvas: "当前画布为空，无法保存配方",
        recipeSaved: "已保存配方",
        recipeApplied: "已应用配方到画布",
        recipeLoadFailed: "配方列表加载失败",
    ...
    config: {
        ...
        localStorage: {
            ...
            description: "查看 Nova Canvas 在浏览器中保存的数据量，并按对象仓库统计内容体积。",
